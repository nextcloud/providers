...
| ![](https://github.com/nextcloud/providers/raw/master/logos/Cloud68.co.png) | :sq: :us: :gr: | ❌ | [Cloud68.co](https://cloud68.co) Offering ready2use Nextcloud instances with admin access, routine backups & human support from long time FLOSS contributors. Servers based in Germany. |

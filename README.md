...
| ![](logos/logo-linuxfabrik.png) | :switzerland: :de: :austria: | ❌ | ❌ | [Linuxfabrik GmbH](https://www.linuxfabrik.ch/) offers Business Services and Enterprise Support for Linux and Open Source applications as well as Hosting on CIS compliant servers in Switzerland.  |
...
| ![](https://raw.githubusercontent.com/nextcloud/providers/master/logos/thegoodcloud.png) | :netherlands: :uk: | ✔️ | ✔️ | [thegood.cloud](https://thegood.cloud) Store, sync and share without compromising your privacy! Online office with Collabora optional. Hosted on our own hardware in Amsterdam. |
